...
namespace Pulumi.Knapcode
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Knapcode.version.txt");
    ...
    internal sealed class KnapcodeResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public KnapcodeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
